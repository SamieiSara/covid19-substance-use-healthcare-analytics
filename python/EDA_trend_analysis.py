...
# Review available sheet names
print("Available Sheets:")
print(excel_file.sheet_names)


# ================================
# SECTION 3: LOAD KEY TABLES
# ================================

# These sheets contain the main tables used for analysis.
# Header rows are adjusted because the CIHI workbook contains
# titles and notes above the actual data tables.
...
hosp_province = pd.read_excel(
    file_path,
    sheet_name="10 Hosp volume by province",
    header=4
)

hosp_characteristics = pd.read_excel(
    file_path,
    sheet_name="11 Hosp characteristics",
    header=4
)
...
# ================================
# SECTION 4: INITIAL DATA REVIEW
# ================================

print("\nED Substance Table Preview:")
print(ed_substances.head())

print("\nHospitalization Substance Table Preview:")
print(hosp_substances.head())

print("\nED Monthly Table Shape:")
print(ed_monthly.shape)

print("\nHospitalization Monthly Table Shape:")
print(hosp_monthly.shape)

print("\nMissing Values in ED Substance Table:")
print(ed_substances.isnull().sum())

print("\nMissing Values in Hospitalization Substance Table:")
print(hosp_substances.isnull().sum())


# ================================
# SECTION 5: BASIC DATA CLEANING
# ================================
